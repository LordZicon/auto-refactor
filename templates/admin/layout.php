...
<body>
    <div id="sidebar">
      ...
      <dt class="mt"><a href="javascript:void(0)" class="accordeon">Occasions</a></dt>
        <dd>
          <ul>
            <li><a href="/admin/occasion/toevoegen" tabindex="1" title="Occasion toevoegen">Occasion toevoegen</a></li>
            <li><a href="/admin/occasion/bewerken" tabindex="2" title="Occasion bewerken">Occasion bewerken</a></li>
            <li><a href="/admin/occasion/verwijderen" tabindex="3" title="Occasion verwijderen">Occasion verwijderen</a></li>
          </ul>    
        </dd>
      <dt class="mt"><a href="" class="accordeon">Links</a></dt>
      <dt class="mt"><a href="" class="accordeon">Naar website</a></dt>
      <dt class="mt"><a href="/admin/logout" class="accordeon">Logout</a></dt>   
      </dl>
    </div>
    <?php echo $content ?>
